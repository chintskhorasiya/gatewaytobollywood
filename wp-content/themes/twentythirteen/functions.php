...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Banner Content', 'twentythirteen' ),
		'id'            => 'banner-content',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
	...
	register_sidebar( array(
		'name'          => __( 'Footer Logo', 'twentythirteen' ),
		'id'            => 'footer-logo',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'social', 'twentythirteen' ),
		'id'            => 'social',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="follow_us">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	) );
...
function custom_theme_assets() {
	...
	//wp_enqueue_style( 'purple', get_template_directory_uri() . '/css/purple.css1' );
