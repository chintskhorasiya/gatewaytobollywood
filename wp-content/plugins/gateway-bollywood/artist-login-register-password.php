...
function complete_registration() {
    ...
    if ( 1 > count( $reg_errors->get_error_messages() ) ) {
        ...
        //echo '<div class="reg-thanks">Thanks for signed in to GATEWAY TO BOLLYWOOD.​</div>';
...
@media screen and (max-width: 700px){
  ...
  .popup{
    ...
    </style><div id="popup1" class="overlay">
                <div class="popup">
                    <h2>Registration Successful</h2>
                    <a class="close" id="close_reg_suc_msg" href="#">&times;</a>
                    <div class="content">
                        Thanks for signed in to GATEWAY TO BOLLYWOOD.​ <a href="'.get_page_link($options['gateway_bollywood_field_login_page']).'">Login here.</a>
                    </div>
                </div>
            </div><script type="text/javascript">jQuery(document).ready(function(){
    jQuery("#close_reg_suc_msg").click(function(){
        jQuery("#popup1").hide();
    });
});</script>';
    }
